...
public class therapist_provide {
    ...
    private LocalDate T_Birth_Date ;

    public therapist_provide(String t_Name, int t_SSN, int therapy_ID, double t_Session_Rate, String t_password, String t_Phone_Num, LocalDate T_Birth_Date ) {
        T_Name = t_Name;
        T_SSN = t_SSN;
    ...
    public LocalDate getT_Birth_Date() {
        return T_Birth_Date;
    }

    public void setT_Birth_Date(LocalDate t_Birth_Date) {
